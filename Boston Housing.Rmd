...
#MSE too high compared to sample mean of roughly 22, maybe the data isn't fit for linear regression, let's see if some underlying assumption of OLS violated.
par(mfrow = c(2, 2))
plot(ols.modfull)
```